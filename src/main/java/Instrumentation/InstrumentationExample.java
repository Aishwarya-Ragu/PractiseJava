...
public class InstrumentationExample {
    ...
    public static void main(String[] arguments) {
        ...
        String[] anotherStringArray = new String[1];
        List<String> stringList = new ArrayList<>();
        StringBuilder stringBuilder = new StringBuilder(20000000);
        ...
        printObjectSize(root);
        printObjectSize(left);
        printObjectSize(right);
